...
const balanceText = first
  ? "Balance " + formatAmount(first.total_balance, first.currency)
...
title: failed ? "DeepSeek balance unavailable" : "DeepSeek (deepseek-official) balance · open DeepSeek platform",
style: {
display: "inline-flex",
alignItems: "center",
gap: "6px",
