...
/**
 * Since 2026-08-23 DeepSeek bills Saturdays and Sundays at the off-peak rate
 * ALL DAY: the peak windows apply to weekdays only.
 */
...
export const PEAK_WINDOW_LABEL = "Beijing weekdays 09:00-12:00, 14:00-18:00 · weekends all-day off-peak";
...
export function formatPricingWindow(date = new Date()) {
  if (isBeijingWeekend(date)) {
    return "Off-peak (50% of peak price) · weekend all-day off-peak";
  }
